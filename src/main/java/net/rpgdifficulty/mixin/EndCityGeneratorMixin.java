...
public class EndCityGeneratorMixin {
    ...
    @Inject(method = "handleMetadata", at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/mob/ShulkerEntity;updatePosition(DDD)V"), locals = LocalCapture.CAPTURE_FAILSOFT)
