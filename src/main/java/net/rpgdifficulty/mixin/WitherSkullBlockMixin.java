...
public class WitherSkullBlockMixin {
    ...
    private static void onPlacedMixin(World world, BlockPos pos, SkullBlockEntity blockEntity, CallbackInfo info, BlockPattern blockPattern, BlockPattern.Result result, WitherEntity witherEntity) {
