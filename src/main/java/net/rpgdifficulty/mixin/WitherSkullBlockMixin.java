...
public class WitherSkullBlockMixin {
    ...
    private static void onPlacedMixin(World world, BlockPos pos, SkullBlockEntity blockEntity, CallbackInfo info, boolean bl, BlockPattern blockPattern, BlockPattern.Result result, WitherEntity i) {
        if (world instanceof ServerWorld) {
            MobStrengthener.changeBossAttributes(i, (ServerWorld) world);
        }
    }
}
